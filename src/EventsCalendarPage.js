                            ...
                            <div
                                ...
                                <div className="absolute w-full h-full rounded-full flex items-center justify-center">
                                    <div className="text-center">
                                        ...
                                        <div className="text-6xl font-bold text-black">19</div>
                    ...
                    {filteredEvents.length > 0 ? (
                                ...
                                <div key={event.id} className="flex border-b border-gray-200 pb-6">
                                    ...
                                    <div className="flex-grow">
                                        <div className="flex items-center mb-2">
                                            <div className="text-gray-600 font-mono">{event.date}, {event.time}</div>
                                            <span className={`ml-3 px-2 py-0.5 text-xs rounded ${
                                                event.type === 'KEYNOTE' ? 'bg-purple-200 text-purple-800' :
                                                    event.type === 'RESEARCH' ? 'bg-blue-200 text-blue-800' :
                                                        event.type === 'WORKSHOP' ? 'bg-orange-200 text-orange-800' :
                                                            event.type === 'SHOWCASE' ? 'bg-green-200 text-green-800' :
                                                                event.type === 'PANEL' ? 'bg-red-200 text-red-800' :
                        ...
                        {event.type}
                          ...
                          {event.category}
                                        ...
                                        {event.speaker && (
                                            <div className="text-sm text-green-600 mb-1">Speaker: {event.speaker}</div>
                                        )}
