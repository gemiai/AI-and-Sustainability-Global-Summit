        ...
        <div className="min-h-screen bg-white text-black font-bold"> 
            <div className="flex flex-col md:flex-row min-h-[calc(100vh-76px)]">
                ...
                <div className="w-full md:w-1/3 border-r border-gray-200 p-8">
                    ...
                    <div className="mb-12 border border-gray-200 rounded-lg p-6 flex flex-col items-center justify-center">
                    ...
                    <div className="relative w-full h-96 mb-12">
                        <div className="absolute inset-0 flex items-center justify-center">
                            <div className="w-64 h-64 rounded-full border border-green-300 bg-gradient-to-br from-green-100 to-blue-100 relative">
                            ...
                            {filteredEvents.map(schedule => (
                                <div key={schedule.id} className="flex border-b border-gray-200 pb-6">
                                    <div className="w-40 h-40 flex-shrink-0 mr-6">
                                        <div className="w-full h-full bg-gray-100 rounded-lg overflow-hidden flex items-center justify-center relative group">
                                            <div className={`w-full h-full flex items-center justify-center relative overflow-hidden rounded-lg ${
                                                ...
                                                {/* Main icon */}
                                                <div className="text-5xl font-bold text-white drop-shadow-lg transform group-hover:scale-110 transition-transform duration-300">
                                                ...
                                                <div className="absolute bottom-0 left-0 right-0 bg-black bg-opacity-60 text-white text-xs font-bold py-1 px-2 text-center transform translate-y-full group-hover:translate-y-0 transition-transform duration-300">
                                                    {schedule.category}
                                                </div>
                                            </div>
                                        </div>
